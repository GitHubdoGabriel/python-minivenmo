...
class FriendEvent:
    ...
    def __init__(self, actor, friend):
        self.id = str(uuid.uuid4())
        self.actor = actor
        self.friend = friend
...
class User:
    ...
    def add_friend(self, new_friend):
        ...
        new_friend.activity.append(event)
...
class MiniVenmo:
    ...
    def render_feed(self, feed):
        for item in feed:
            ...
            elif isinstance(item, FriendEvent):
                print(f"{item.actor.username} and {item.friend.username} became friends")
